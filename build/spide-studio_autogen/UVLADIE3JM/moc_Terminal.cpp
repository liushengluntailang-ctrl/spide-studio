...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Terminal_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Terminal_t qt_meta_stringdata_Terminal = {
    {
        QT_MOC_LITERAL(0, 8),  // "Terminal"
        QT_MOC_LITERAL(9, 10),  // "runCommand"
        QT_MOC_LITERAL(20, 0)   // ""
    },
    "Terminal",
    "runCommand",
...
Q_CONSTINIT static const uint qt_meta_data_Terminal[] = {
...
Q_CONSTINIT const QMetaObject Terminal::staticMetaObject = { {
    ...
    qt_meta_stringdata_Terminal.offsetsAndSizes,
    qt_meta_data_Terminal,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Terminal_t,
        // Q_OBJECT / Q_GADGET
