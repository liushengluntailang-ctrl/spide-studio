...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AIChat_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AIChat_t qt_meta_stringdata_AIChat = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_AIChat[] = {
...
Q_CONSTINIT const QMetaObject AIChat::staticMetaObject = { {
    ...
    qt_meta_stringdata_AIChat.offsetsAndSizes,
    qt_meta_data_AIChat,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_AIChat_t,
        // Q_OBJECT / Q_GADGET
